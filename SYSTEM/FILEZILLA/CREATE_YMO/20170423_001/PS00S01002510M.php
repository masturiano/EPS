...
# [SUB_ID]:						[SUBSYS]  : 
# [PRC_ID]:						[PROCESS] : 
# [PGM_ID]: PS00S01000650M.php	[PROGRAM] : Create YMO Lot
# [MDL_ID]:						[MODULE]  : 
# --------------------------------------------------------------------------------------
# [COMMENT]
# 
...
# ====================	==================	============================================
# DOS)Y.Nishigami       2014.04.25			UTAC対応 メッセージ追加
# --------------------------------------------------------------------------------------

function PS00S01000650_item($label)
{
	$item = array
	(
...
function PS00S01000650_msg($label)
{
	$msg = array
	(
		# input check error
