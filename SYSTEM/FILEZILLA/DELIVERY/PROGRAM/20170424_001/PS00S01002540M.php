...
# [SYS_ID]: GPRISM				[SYSTEM]  : 組立標準CIM
# [SUB_ID]:						[SUBSYS]  : 
# [PRC_ID]:						[PROCESS] :
# [PGM_ID]: PS00S01000790M.php	[PROGRAM] : 出荷(LD)
# [MDL_ID]:						[MODULE]  : 
# -----------------------------------------------------------------------------------
# [COMMENT]
# 
...
function PS00S01000790_item($label)
{
	$item = array
	(
		"ScreenTitle"	=> "*** Delivery(BGA) ***",
...
function PS00S01000790_msg($label)
{
	$msg = array
	(
		# 入力エラー
