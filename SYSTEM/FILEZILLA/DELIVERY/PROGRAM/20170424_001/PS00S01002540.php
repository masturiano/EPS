...
# [SYS_ID]: GPRISM				[SYSTEM]  : PMS
# [SUB_ID]:					[SUBSYS]  : 
# [PRC_ID]:					[PROCESS] : 
# [PGM_ID]: PS00S01000790.php			[PROGRAM] : DELIVERY (BGA)
# [MDL_ID]:					[MODULE]  : 
# ------------------------------------------------------------------------------------------
# [COMMENT]
#
...
require_once ($g_lang_dir . "/PS00S01000790M.php");
...
function itm($var)
{
	return PS00S01000790_item($var);
}
function msg($var)
{
	return PS00S01000790_msg($var);
}
#******************************************************************
#******************************************************************
#******************************************************************
