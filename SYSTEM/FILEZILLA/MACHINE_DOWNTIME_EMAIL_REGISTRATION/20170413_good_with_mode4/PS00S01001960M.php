...
function PS00S01001960_msg($label, $lev = false) {
	...
	$msg = array(
		...
		"err_chk_Email_NotFound"	=> array("msg" => "Email address is not found in employee master. Invalid Emails Addresses are :",				"lv" => 0 ),
		...
		"suc_Ins_User_id"			=> array("msg" => "User id are maintained successfully.",							"lv" => 0),
		"suc_Ins_User_id_Exist_All"	=> array("msg" => "User id were all existing.",										"lv" => 0),
		"suc_Upd_ParMst"			=> array("msg" => "Success to update.",												"lv" => 0),
	);
