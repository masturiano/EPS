...
// function get_step_code($w_lot_id, &$step_code) {

//         //$w_sql = "select * from lot_log where lot_id= '$w_lot_id' and verb='IORV' and del_flg='0'";
//         $w_sql = "select * from lot_log where lot_id = '$w_lot_id' and verb='IOMV' and del_flg='0'";

//         $w_stmt = db_res_set($w_sql);

//         $w_rtn  = db_do($w_stmt);
//         if ($w_rtn != 0) {
//                 $g_msg = xgt_lot_msg("error_1");
//                 return $w_rtn;
//         }

//         $r_lot_bas = db_fetch_row($w_stmt);
//         if (!$r_lot_bas) {
//                 db_res_free($w_stmt);
//                 $g_msg = xgt_lot_msg("error_2");
//                 return 4000;
//         }

//         db_res_free($w_stmt);
	
// 	$step_code = $r_lot_bas['STP_CD'];
